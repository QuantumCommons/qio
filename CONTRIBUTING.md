...
`qio` is Apache 2.0 licensed and accepts contributions via GitHub.
...
- The version of `qio` you are using
- Python version
...
- Does this align with the goals of `qio`?
...
- Open a pull request against `qio` master branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `qio` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
